...
// Set individual properties for use in the template
...
$f3->set('githubLink', $applicant->getGithub());
$f3->set('yearsExperience', $applicant->getExperience());
$f3->set('relocate', $applicant->getRelocate());
    // Only set selectedJobs if the applicant has opted into job list selections
    if ($applicant instanceof Applicant_SubscribedToLists) {
        $f3->set('selectedJobs', $applicant->getSelectionsJobs());
    }
$view = new Template();
